#wx_chess_settings_control_panel_base.py
""" 
chess display control settings
...
class ChessSettingsControlPanel(wx.Panel, SettingsDisplay):
...
if __name__ == '__main__':
    ...
    controls_data_panel = ChessSettingsControlPanel(
                controls_panel,
