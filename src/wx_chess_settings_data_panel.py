#wx_chess_settings_data_panel.py
""" 
Chess data display settings
...
class ChessSettingsDataPanel(wx.Panel, SettingsDisplay):
    ...
    def __init__(self, parent=None, title=None, size=None,
        ...
        game_interval_panel = wx.Panel(settings_panel)
        game_interval_sizer = wx.BoxSizer(wx.HORIZONTAL)
        game_interval_panel.SetSizer(game_interval_sizer)        
        settings_sizer.Add(game_interval_panel, wx.EXPAND)
        game_interval_panel.SetSizer(game_interval_sizer)
        game_interval_label = wx.StaticText(
            game_interval_panel, wx.ID_ANY, 'Game Interval')
        game_interval_sizer.Add(game_interval_label)
        self.tc_game_interval = wx.TextCtrl(game_interval_panel,
                                    wx.ID_ANY, size=(40,20),
                                    style=wx.TE_PROCESS_ENTER)        
        self.Bind(wx.EVT_TEXT_ENTER, self.cmd_enter_game_interval,
                  self.tc_game_interval)
        game_interval_sizer.Add(self.tc_game_interval, wx.EXPAND)
        ...
        self.name_to_info = {
            ...
            "Set_FASTEST_Run" :{"wid" : self.cb_set_fastest_run,
                               "__not_data__" : True},
            
            "Move_Interval" : {"wid" :self.tc_move_interval,
                               "type" : int},
            "Game_Interval" : {"wid" :self.tc_game_interval,
                               "type" : int}
        }
    ...
    def cmd_enter_game_interval(self, event=None):
        self._update_setting("Game_Interval")
...
if __name__ == '__main__':
    ...
    settings_data_panel = ChessSettingsDataPanel(settings_panel,
                                title="data panel", size=size) 
