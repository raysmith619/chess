...
"""
Implemened with a move (undo/redo) using stack within the board chessboard.py (Chessboard)
The new plan is to use a board stack (ChessboardStack) to provide move do/undo/redo
